...
5. Run tests before submitting the PR.
6. You may merge the PR once you have gained approval, or you may request approval from the maintainers who have write access to the repository.
